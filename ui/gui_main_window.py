from PySide6.QtWidgets import QMainWindow, QTabWidget, QSplitter, QStatusBar, QShortcut
...
class MainWindow(QMainWindow):
    def __init__(self, config):
        ...
        self.tabs.addTab(CharacterEditorPanel(self.character_system), "🧍 Charakter")
